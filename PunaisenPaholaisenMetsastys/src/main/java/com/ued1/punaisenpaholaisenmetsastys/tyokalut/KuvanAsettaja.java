...
public class KuvanAsettaja {
    ...
    /**
     * Metodi asettaa kuvan parametrina saatuun JLabel-olioon mikäli kuva löytyy
     * Map-oliosta kuvausta vastaavalla key:llä. Mikäli kuva löytyy, asetetaan
     * kuvaus ToolTip-tekstiksi. Mikäli kuvausta ei löydy, palautetaan JLabel
